...
imu_path = ".\\tilt_box_data\\Imu\\" + "0001" + ".npy"
lidar1_point_cloud_path = ".\\tilt_box\\lidar1\\tilt_box" + "0000" + ".npy"
lidar1_point = np.load(lidar1_point_cloud_path)
...
for ind in range(1, max_ind):
	...
	lidar1_point_cloud_path = ".\\tilt_box\\lidar1\\tilt_box" + tmp_index + ".npy"
	lidar2_point_cloud_path = ".\\tilt_box\\lidar2\\tilt_box" + tmp_index + ".npy"
	image_path = ".\\tilt_box_data\\Images\\" + data_index + ".png"
	imu_path = ".\\tilt_box_data\\Imu\\" + data_index + ".npy"
	...
	box_x_1 = [list(lidar1_wall[np.argmin(lidar1_wall[:, 0])])]
	box_x_2 = [list(lidar2_wall[np.argmin(lidar2_wall[:, 0])])]
	# print(box_x_1)
...
(y, p, r, t_y), error_list = newton_raphson.tilt_box_fit(train_data_x, train_data_y, [0, 0, 0, 0.17])
print(y, p, r, t_y)
...
for i in range(50, max_ind-1):
	...
	# R_3 = np.identity(3)
	T_3 = np.array([[-0.003917707], [0.17986587], [0.17740681]])
	lidar2_box = np.dot(lidar2_box, compute_R_lidar((y, p, r)).T) + np.array([-0.0039, t_y, 0.177])
	...
	lidar2_x_list.append(np.abs((lidar2_box[0, 0]-lidar1_box[0, 0]) / t_y - np.tan(151 * np.pi / 180)))
